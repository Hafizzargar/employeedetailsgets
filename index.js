let emp=[{"id":1,"first_name":"Chadwick","last_name":"Ayre","email":"cayre0@cam.ac.uk","gender":"Male","img_src":"https://robohash.org/corporisquiaperiam.png?size=50x50&set=set1","class":11,"marks":18,"passing":false,"city":"Moorreesburg"},
...
let inp=document.getElementById("sea");  //input
let bu=document.getElementById("bu1");   //seach button
...
bu.addEventListener("click",(event)=>{
    ...
    for(let i of emp){
        let fln=i.first_name.toLowerCase()+" "+i.last_name.toLowerCase();
        
        let et1={ID:undefined,Name:undefined,gender:undefined,class:undefined,marks:undefined,passing:undefined,email:undefined,img_src:undefined};
       
        if(fln.includes(inp.value.toLowerCase())){
...
function az() {
    ...
    for (let z in getting) {
        let z1=getting[z];

        console.log(getting[z]);
...
form.addEventListener("submit",(e)=>{
    ...
    newemp.first_name=form.fn.value;
    newemp.last_name=form.ln.value;
    newemp.gender=form.gender.value;
    // newemp.email=form.email.value;
    newemp.class=form.class.value;
    newemp.marks=form.marks.value;
    newemp.email=form.email.value;
    newemp.passing=form.passing.value;
    newemp.city=form.city.value;;
